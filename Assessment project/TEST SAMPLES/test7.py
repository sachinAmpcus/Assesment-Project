...
def generate_question(content):
    ...
    # Prepare a clearer prompt for question generation
    prompt = f"Based on the following information: {summarized_content}, create a multiple-choice question with one correct answer and three distractors."
